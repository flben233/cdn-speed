...
```shell
wget https://github.com/flben233/cdn-speed/releases/download/v20260503-062319/cdn-speed-linux-amd64 && chmod +x ./cdn-speed-linux-amd64 && { ./cdn-speed-linux-amd64; rm -f ./cdn-speed-linux-amd64; }
```
